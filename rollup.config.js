...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-template.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-template',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-template.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-template.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-template.esm.js',
    }),
  ],
};
